(function() {
  ...
  */
  ...
  _validate = function(data) {
    ...
    for (key in data) {
      value = data[key];
      if (key !== 'name' && key !== 'author' && key !== 'vendor' && key !== 'comment' && key !== 'deviceType' && key !== 'bankchain' && key !== 'types' && key !== 'modes' && key !== 'syncFilename' && key !== 'removeUnnecessaryChunks') {
